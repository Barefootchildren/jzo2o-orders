...
public class OrdersCreateServiceImpl extends ServiceImpl<OrdersMapper, Orders> implements IOrdersCreateService {
    ...
    public void add(Orders orders) {
        ...
        OrderSnapshotDTO snapshotDTO = BeanUtils.toBean(baseMapper.selectById(orders.getId()), OrderSnapshotDTO.class);
        orderStateMachine.start(orders.getUserId(), String.valueOf(orders.getId()), snapshotDTO);
    }
